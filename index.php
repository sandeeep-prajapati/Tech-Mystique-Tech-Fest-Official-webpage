                ...
                <div class="row p-4">
                    <div class="col-lg-7">
                        <div class="hero-text">
                            ...
                            <a href="register.php" class="primary-btn m-2">Participate(for external)</a>
                            <!-- <a href="https://parampara.mrcool.in/" class="primary-btn m-2">Participate(for internal)</a> -->
                        </div>
                    </div>
                    <div class="col-lg-5">
                                ...
                                <div class="col-lg-12">
                                    <div class="schedule-tab">
                                        <div class="st-content">
                                            <div class="container">
                                                <h3 class="text-danger text-center">Organisation Committee head</h3>
                                                <div class="row">
                                                    <div class="col-lg-3">
                                                        <div class="sc-pic text-center">
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="latest-item set-bg large-item" data-setbg="home/img/blog/latest-b/latest-1.jpeg">
                            ...
                            <div class="li-text">
                                <h4><a href="#">Parampara 2K24: Celebrating tradition and innovation with a vibrant showcase of culture and talent</a></h4>
                                <span><i class="fa fa-clock-o"></i> 9th March, 2024</span>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="latest-item set-bg" data-setbg="home/img/blog/latest-b/latest-2.jpeg">
                            ...
                            <div class="li-text">
                                <h5><a href="#">Experience the vibrant blend of tradition and modernity at our college's annual fest, Parampara 2K24 again.</a></h5>
                                <span><i class="fa fa-clock-o"></i> 07th April, 2023</span>
                            </div>
                        </div>
                        <div class="latest-item set-bg" data-setbg="home/img/blog/latest-b/latest-3.jpeg">
                            <div class="li-tag">Winning</div>
                            <div class="li-text">
                                <h5><a href="#">Experience Parampara 2K24: Embrace tradition, innovation, and win exciting prizes at our captivating annual college fest!</a></h5>
                                <span><i class="fa fa-clock-o"></i> 09th April, 2023</span>
                            </div>
                        </div>
                    </div>
                </div>
