...
<body>
  ...
  $query1 = "select * from participants where position = 'event-head' and type = 'technical'";
  ...
  <h1 class="text-center text-primary">List of all event head who lead a event of cultural events</h1>
  <div class="row">

  <?php
  require './admin/connect.php';
  $query1 = "select * from participants where position = 'event-head' and type = 'cultural'";
  $exe1 = mysqli_query($dbc, $query1);
  while ($row1 = mysqli_fetch_array($exe1)) {
    $p_id = $row1['eid'];
    $name = $row1['name'];
  ...
  <h1 class="text-center text-warning">List of all event head who lead a event of sport events</h1>
  <div class="row">
  <?php
  require './admin/connect.php';
  $query1 = "select * from participants where position = 'event-head' and type = 'Sport'";
  $exe1 = mysqli_query($dbc, $query1);
  while ($row1 = mysqli_fetch_array($exe1)) {
    $p_id = $row1['eid'];
    $name = $row1['name'];
