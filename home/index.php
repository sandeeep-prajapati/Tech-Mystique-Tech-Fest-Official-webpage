<?php
$conn=mysqli_connect("localhost","root","","enigma");
if(!$conn){
    echo "Page Not Found.";
}
else{
                                ...
                                <div class="st-content">
                                    <div class="container">
                                        <div class="row">
                                            <div class="col-lg-3">
                                                <div class="sc-pic">
                                                    <img src="./newimg/krishna.jpg" alt="">
                                                </div>
                                            </div>
                                            <div class="col-lg-5">
                                                <div class="sc-text">
